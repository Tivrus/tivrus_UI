...
class CTkButton(CTkBaseClass):
    ...
    def __init__(self,
                 ...
                 width: int = 140,
                 height: int = 28,
                 corner_radius: Optional[Union[int, Tuple[int, int, int, int]]] = None,
        ...
        # shape
        self._corner_radius = (
            ThemeManager.theme["CTkButton"]["corner_radius"] if corner_radius is None
            else corner_radius if isinstance(corner_radius, int)
            else corner_radius if isinstance(corner_radius, tuple) and len(corner_radius) == 4
            else ValueError("corner_radius can be only None, int, or a tuple with 4 int")
        )
